    ...
    public partial class MainWindow : Window
    {
        ...
        private void TimerCounter_Tick(object sender, EventArgs e)
        {
            ...
            if (PublicParamerters.SimulationTime <= Settings.Default.StopSimlationWhen + PublicParamerters.MacStartUp)
            {
                ...
                Title = "BLine:" + PublicParamerters.SimulationTime.ToString();
            }
            else
            {
        ...
        private void GenerateRandomPacket()
        {
            ...
            //if (TimeSpan.Compare(sensor.NextqueryAfter, currentTime) == 1 || sensor.isAgentAvailable())
            //{
